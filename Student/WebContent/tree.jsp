...
var treeMenu = [
	{ level:1, name:"学生管理"},
	{ level:2, name:"学生列表", ico:"images/icon_default.gif",link:"student/Student_query_success.jsp"},
	{ level:1, name:"教师管理"},
	{ level:2, name:"教师列表", ico:"images/icon_default.gif",link:"#"},
	{ level:1, name:"信息管理"},
	{ level:2, name:"新闻管理", ico:"images/icon_default.gif",link:"#"},
	{ level:2, name:"公告管理", ico:"images/icon_default.gif",link:"#"},
	{ level:1, name:"系统邮件", ico:"images/icon_default.gif"},
	{ level:1, name:"网络文件", ico:"images/icon_default.gif",link:"#"}
];
</script>
